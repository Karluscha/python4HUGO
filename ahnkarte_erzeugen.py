...
VV_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(VV['anr'])

MV_Text = "{:s} {:s}<br>* {:}".format(VV['Vorname'],MV['Name'], MV['geb'])
MV_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(MV['anr'])

VM_Text = "{:s} {:s}<br>* {:}".format(VV['Vorname'],VM['Name'], VM['geb'])
VM_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(VM['anr'])

MM_Text = "{:s} {:s}<br>* {:}".format(VV['Vorname'],MM['Name'], MM['geb'])
MM_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(MM['anr'])
...
V_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(V['anr'])

M_Text = "{:s} {:s}<br>* {:}".format(M['Vorname'],M['Name'], M['geb'])
M_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(M['anr'])
...
P_Bild = "../Fam2/static/ahnbilder/g{:d}.jpg".format(P['anr'])
...
for kid in Kids:
    ...
    k_Bild = "../Fam2/static/ahnbilder/k{:d}.jpg".format(kid['anr'])
